...
def play():
    ...
    classroom = Room(WINDOW_SIZE_X, WINDOW_SIZE_Y, "assets/classroom.png", display_surface)
    ...
    constants = {
        ...
        "desk_big": [pygame.image.load("assets/desk_big.png").get_rect().size, pygame.image.load("assets/desk_big.png"),
                     1, .6, "desk_big"],
    ...
    Obj1 = [
        ...
        Object(rect=pygame.draw.rect(display_surface, (255, 0, 0), (310, 85, 30, 60)),
               texture=pygame.image.load("assets/teacher_npc.png"),
               scale_x=0,
               scale_y=0,
               name="teacher",
               number="null",
    ...
    player = Player(pos_x=720, pos_y=450, size_x=50, size_y=70, move_speed=5, sprite="assets/player-0.png", sprite_2="assets/player-1.png",
                    display_surface=display_surface, Objects=Obj1)
    timer = Timer(0, params={"size": (20, 500), "position": (50, 545), "color": (0, 0, 0), "text_size": 35})
        ...
        while True:
            ...
            if start_value == 0:
                ...
                if right == 6:
                    if door_box.colliderect(player.player_pos_x, player.player_pos_y, player.player_size_x,
                        ...
                        if pygame.key.get_pressed()[K_e]:
                            if play2(first_try, timer) == "restart":
                                # print("exectue")
                                play()
                ...
                if right == 6:
                    ...
                    # pygame.draw.rect(display_surface, black, door_open)
                    if door_box.colliderect(player.player_pos_x, player.player_pos_y, player.player_size_x,
                                            player.player_size_y):
