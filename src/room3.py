...
def play3(first_try2, timer):
    ...
    classroom = Room(WINDOW_SIZE_X, WINDOW_SIZE_Y, "assets/class3.png", display_surface)
    ...
    constants = {
        ...
        "desk_big": [pygame.image.load("assets/desk_room3.png").get_rect().size, pygame.image.load("assets/desk_room3.png"), 1,
                     .6, "desk_big"],
    ...
    Obj1 = [
        ...
        Object(rect=pygame.draw.rect(display_surface, (255, 0, 0), (0, 0, 65, 70)),
               ...
               number="null",
               status="null"),
        Object(rect=pygame.draw.rect(display_surface, (255, 0, 0), (0, WINDOW_SIZE_Y - 80) + pygame.image.load(
            "assets/class_bottom.png").get_rect().size),
        ...
        Object(rect=pygame.draw.rect(display_surface, (255, 0, 0), (310, 85, 30, 60)),
               texture=pygame.image.load("assets/teacher_3.png"),
               scale_x=0,
               scale_y=0,
               name="teacher",
               number="null",
    ...
    for object in Obj1:
        if object.name == "desk_small":
            Obj1.append(Object(rect=pygame.draw.rect(display_surface, (255, 0, 0), (
            object.texture_pos_x + random.randint(0, 3), object.texture_pos_y - random.randint(12, 16)) + (26, 38)),
    ...
    player = Player(pos_x=720, pos_y=90, size_x=50, size_y=70, move_speed=5, sprite="assets/player-0.png", sprite_2="assets/player-1.png",
                    display_surface=display_surface, Objects=Obj1)
    Title = "Classroom Hero by UNHP Comp Sci Club"
    Icon = pygame.image.load("assets/logo.png")

    index = [0, 0]
    display_surface.blit(sheet, (200, 200),
                         ((constants["player"][0] * index[0]), (constants["player"][1] * index[1])) + tuple(
                             constants["player"]))
    ...
    def update():
        start_value = 1
        right = 0
        door_box = pygame.Rect(700, 500, 100, 100)
        first_try3 = first_try2
        while True:
            ...
            if start_value == 0:
                ...
                if right == 6:
                    if door_box.colliderect(player.player_pos_x, player.player_pos_y, player.player_size_x,
                        ...
                        if pygame.key.get_pressed()[K_e]:
                            report = end_menu(first_try3, timer)
                            if report == "restart":
                                return "restart"
                player.render(display_surface)
                for object in Obj1:
                ...
                if right == 6:
                    ...
                    if door_box.colliderect(player.player_pos_x, player.player_pos_y, player.player_size_x,
                                            player.player_size_y):
                        display_text(display_surface, "Press E to exit", (429, 478), font_next, (25, 25, 25), "null")
                else:
